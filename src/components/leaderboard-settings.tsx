        ...
        >
          <Tabs defaultValue="settings">
            ...
            <TabsContent value="info">
              <div className="p-4">
                <p>
                  Ride leaderboards are delayed by one day to allow more people
                  to participate. They include all riders in the tag that did
                  the ride from 12 hours before NL until the start of NL's
                  stream the following day.
                </p>
                <p className="mt-4">
